...
::: {.callout-note}
## Response 4
Even with 100 years of data, we still have a decent amount of undcertainty in our 250 year return period, from 10 inches all the way to 20 inches.  If building infrastructure to a 250 year standard, I would pursue a sample size of 100 years or larger and set a large safety factor.  
...
When designing infrastructure in response to climate risk, we need to accurately asses risk, and then base large safety margins off of that assesment.  As important as it is to ask if we can afford to build a piece of infrastructure to a certain standard, we should also ask if we can afford to have that piece of infrastructure fail.  
